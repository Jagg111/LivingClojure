...
var seq__1499_1503 = cljs.core.seq.call(null,clojure.browser.repl.print_queue);
var chunk__1500_1504 = null;
var count__1501_1505 = (0);
var i__1502_1506 = (0);
while(true){
if((i__1502_1506 < count__1501_1505)){
var str_1507 = cljs.core._nth.call(null,chunk__1500_1504,i__1502_1506);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_1507})));


var G__1508 = seq__1499_1503;
var G__1509 = chunk__1500_1504;
var G__1510 = count__1501_1505;
var G__1511 = (i__1502_1506 + (1));
seq__1499_1503 = G__1508;
chunk__1500_1504 = G__1509;
count__1501_1505 = G__1510;
i__1502_1506 = G__1511;
continue;
} else {
var temp__5457__auto___1512 = cljs.core.seq.call(null,seq__1499_1503);
if(temp__5457__auto___1512){
var seq__1499_1513__$1 = temp__5457__auto___1512;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__1499_1513__$1)){
var c__4461__auto___1514 = cljs.core.chunk_first.call(null,seq__1499_1513__$1);
var G__1515 = cljs.core.chunk_rest.call(null,seq__1499_1513__$1);
var G__1516 = c__4461__auto___1514;
var G__1517 = cljs.core.count.call(null,c__4461__auto___1514);
var G__1518 = (0);
seq__1499_1503 = G__1515;
chunk__1500_1504 = G__1516;
count__1501_1505 = G__1517;
i__1502_1506 = G__1518;
continue;
} else {
var str_1519 = cljs.core.first.call(null,seq__1499_1513__$1);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_1519})));


var G__1520 = cljs.core.next.call(null,seq__1499_1513__$1);
var G__1521 = null;
var G__1522 = (0);
var G__1523 = (0);
seq__1499_1503 = G__1520;
chunk__1500_1504 = G__1521;
count__1501_1505 = G__1522;
i__1502_1506 = G__1523;
continue;
}
} else {
}
...
var script__$1 = (function (){var G__1528 = script;
goog.object.set(G__1528,"type","text/javascript");

goog.object.set(G__1528,"onload",onload);

goog.object.set(G__1528,"onreadystatechange",onload);

return G__1528;
})();
if((opt_sourceText == null)){
var G__1529 = script__$1;
goog.object.set(G__1529,"src",src);

return G__1529;
} else {
var G__1530 = script__$1;
goog.dom.setTextContext(G__1530,opt_sourceText);
...
var path_1531 = goog.debugLoader_.getPathFromDeps_(cljs.core.name);
goog.object.remove(goog.debugLoader_.written_,path_1531);

goog.object.remove(goog.debugLoader_.written_,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_1531)].join(''));
} else {
var path_1532 = goog.object.get(goog.dependencies_.nameToPath,src);
goog.object.remove(goog.dependencies_.visited,path_1532);

goog.object.remove(goog.dependencies_.written,path_1532);

goog.object.remove(goog.dependencies_.written,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_1532)].join(''));
}
} else {
}
...
return clojure.browser.net.transmit.call(null,repl_connection,new cljs.core.Keyword(null,"send-result","send-result",35388249),goog.json.serialize(({"repl": repl, "result": (function (){var _STAR_repl_STAR__orig_val__1533 = clojure.browser.repl._STAR_repl_STAR_;
var _STAR_repl_STAR__temp_val__1534 = repl;
clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR__temp_val__1534;

try{return clojure.browser.repl.evaluate_javascript.call(null,repl_connection,form);
}finally {clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR__orig_val__1533;
}})()})));
});})(connected_QMARK_,repl_connection))
);
